...
function display1() {
    ...
    var dicg = [{ name: "Messi", r_No: "10", dob: "19-05-1922" },
    { name: "Neymar", r_No: "11", dob: "19-06-2003" }];

    for (var i = 0; i < dicg.length; i++) {
        if (parseInt(dicg[i].dob.split("-")[2]) < 2000) {
            document.getElementById('Std1').innerHTML += "<b>Player Name: </b>" + dicg[i].name + ",<b> Number: </b> "
